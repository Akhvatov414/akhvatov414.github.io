...
let initSwiper = (slider, sliderItem, sliderWidth) => {
...
initSwiper(mySlider, 'swiper__item', 240);
initSwiper(sliderTypes, 'swiper__item', 240);
initSwiper(sliderPrice, 'section-table__row', 295);
